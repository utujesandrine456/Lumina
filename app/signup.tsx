        ...
        <>
                <ScrollView contentContainerStyle={{ }}>
                    <View style={{ paddingBlock: 30, backgroundColor: 'white'}}>
                        ...
                        <MonoText style={{ fontSize: 16, textAlign: 'center', color: '#5E5E5E', marginBlock: 10}}>Sign up for free so as to be able to transport your crops to any location.</MonoText>
                        ...
                        <Text style={{ color: '#767676ff', textAlign: 'center', marginBlock: 20, fontSize: 17, fontFamily: 'Poppins_500Medium'}}>Already have an  Account? <Link href="/login"><MonoText style={{ textDecorationLine: 'underline', marginLeft: 10, fontWeight: 'bold'}}>Login</MonoText></Link></Text>
                    </View>
                </ScrollView>
        </>
    )

            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
                ...
                <Animated.View entering={FadeInDown.delay(250).springify()} style={styles.vehicleCard}>
                    ...
                    <View style={styles.vehicleContent}>
                        <Image source={require('@/assets/images/DaihatsuRB.png')} style={styles.vehicleImage} resizeMode="contain" />
                        <View style={styles.vehicleDetails}>
                            <Text style={styles.vehicleName}>Daihatsu Hijet</Text>
                            <Text style={styles.vehiclePlate}>RAD 246 F</Text>
